...
import { PCSetupBuilder } from '@/lib/pc-setup-builder'
...
const handleSaveSetup = async (selectedComponents: SelectedComponents, totalSpent: number) => {
  try {
    ...
    const setupDTO = new PCSetupBuilder()
      .setBudget(budget)
      .withCPU(selectedComponents.cpu)
      .withMotherboard(selectedComponents.motherboard)
      .withRAM(selectedComponents.ram)
      .withGPU(selectedComponents.gpu)
      .withPSU(selectedComponents.psu)
      .build()

    console.log('JSON alinhado com o Backend Java:', JSON.stringify(setupDTO, null, 2))
